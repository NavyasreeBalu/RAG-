...
6. The final submission should be presented in a structured format (for example: table or short report) that clearly demonstrates the improvement over the baseline.
